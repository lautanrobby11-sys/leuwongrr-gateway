...
6. Deployment remains manual and uses the canonical deploy script. It verifies the outer checksum, inner manifest, config permissions, preflight, liveness, readiness, and automatic rollback.
