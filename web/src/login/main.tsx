...
const FEATURES: Array<{ icon: IconName; title: string; body: string }> = [
  ...
  { icon: 'gauge', title: 'Budget terkonfigurasi', body: 'Rate limit, concurrency, entitlement, dan budget harian per tenant mengikuti kebijakan operator.' },
