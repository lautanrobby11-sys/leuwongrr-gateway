...
export const PUBLIC_ALLOWLIST: readonly AllowedRoute[] = Object.freeze([
  ...
  {
    method: 'POST',
    pattern: /^\/console\/api\/admin\/(plans|models(\/policy|\/sync|\/bulk)?|model-groups(\/[a-z0-9-]{2,64}\/models)?|accounts\/limits|accounts\/credit|accounts\/status|exchange-rate)$/,
    id: 'console.admin'
  },
  {
    method: 'PUT',
...
export const DOCUMENTED_OPERATIONS: readonly DocumentedOperation[] = Object.freeze([
  ...
  { method: 'POST', path: '/console/api/admin/models/bulk', sample: '/console/api/admin/models/bulk', id: 'console.admin' },
